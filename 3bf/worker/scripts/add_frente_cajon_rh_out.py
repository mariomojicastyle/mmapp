...
def add_frente_de_cajon():
    print("=== Configurando RH_OUT:Frente de Cajon en el XML de Grasshopper ===")
    ...
    frente_guid = "24d5a658-4462-4439-9783-ca5c1fb406a0"
    frente_group_guid = "21357664-82a4-4591-a3dc-e639b571132f"
        ...
        if name_elem is not None and name_elem.text == "Group":
            ...
            if container is not None:
                ...
                if items_block is not None:
                    ...
                    if frente_guid in contained:
                        if nick_item is not None:
                            nick_item.text = "RH_OUT:Frente de Cajon"
                            print("  * Grupo contenedor de Frente de Cajon actualizado a 'RH_OUT:Frente de Cajon'")
    ...
    print(f"[OK] {updated_comps} referencias a Frente de Cajon actualizadas.")
