...
if __name__ == "__main__":
    ...
    test_clean_original(1200, 900, 500)
    print("\n--- Prueba 2: 600 x 600 x 300 ---")
    test_clean_original(600, 600, 300)
