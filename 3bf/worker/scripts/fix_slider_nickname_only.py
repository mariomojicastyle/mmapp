...
def fix_slider_nickname_only():
    ...
    # 2. Grupo del Slider Ancho y Grupos de Salida
    for item in root.iter("chunk"):
        ...
        if name_elem is not None and name_elem.text == "Group":
            ...
            if container is not None:
                ...
                if items_block is not None:
                    ...
                    elif nick_item is not None and nick_item.text:
    ...
    eval_ancho_clean(600)
    eval_ancho_clean(900)

if __name__ == "__main__":
    fix_slider_nickname_only()
