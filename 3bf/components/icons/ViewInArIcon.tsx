...
interface ViewInArIconProps extends React.SVGProps<SVGSVGElement> {
  className?: string;
  size?: number | string;
}

/**
 * Icono Oficial de Realidad Aumentada (Google Material Symbols: view_in_ar rounded)
 * Utilizado de manera canonica en el aplicativo de manuales de armado y en 3dBimFab.
 */
export default function ViewInArIcon({
  className = "w-5 h-5",
  size,
  ...props
}: ViewInArIconProps) {
