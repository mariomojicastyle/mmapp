...
- [x] **[13 de Septiembre, 2026] Hito 117: Regla Suprema de Visibilidad en Visor 3D, Desacople de Cinemáticas del Manual 3D, Control Global de Bloques Funcionales (P00) y Optimización de Carga a 60 FPS**:
  ...
  - **Próximo Foco Activo (Rama `3BF_P01_inicio`)**: Configuración detallada de la secuencia de ensamble del Paso 01 (estructura base, travesaños y patas), acople concéntrico de herrajes y validación física paso a paso.
