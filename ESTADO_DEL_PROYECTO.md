...
- [x] **[NUEVO - 21 de Agosto, 2026] Hito 3BF_Undo_Redo_Rename (Historial Profundo de 100 Operaciones Ctrl+Z / Ctrl+Y, Renombrado Interactivo en HUD 3D & Exportación Multi-Pieza DXF)**:
  ...
  - **Exportación Multi-Pieza DXF (1 Archivo por Tablero)**: Descarga secuencial automática de archivos DXF independientes por cada tablero (`Cubierta_498x480_15mm_BD1.0.dxf` y `Cubierta_01_498x480_15mm_BD1.0.dxf`) con sus respectivas perforaciones inter-componentes, botón de descarga rápida individual por fila en Despiece y depuración del residuo hardcodeado `"Minifix"`.
