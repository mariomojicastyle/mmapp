...
- [x] **[NUEVO - 15 de Julio, 2026] Corrección de LinkedIn de Notável en CRM (Baserow):** Se actualizó la URL de **Móveis Notável** (ID 2) a su perfil de compañía oficial y verificado `https://www.linkedin.com/company/notável-design-móveis/` (encontrado manualmente por el usuario), conservando intactos el resto de enlaces del Tier 2.
- [x] **[NUEVO - 15 de Julio, 2026] Expansión Multicanal y WhatsApp en CRM (Baserow):** Creación de 5 nuevos campos (`Facebook`, `Instagram`, `WhatsApp`, `Canal Preferido` y `Actividad en Redes`) en la tabla de Empresas (ID 991). Se actualizó la información de las 15 empresas, determinando que para 13 de ellas la red más activa (canal preferido) es **Instagram**, para **Poliman Móveis** es **WhatsApp** (canal directo verificado por el usuario) y para Ditália Móveis es el **Sitio Web**. Las columnas se ordenaron de forma consecutiva tras `LinkedIn Corporativo`.
