  ...
  try {
    ...
    const leads = [
      {
        firstName: "Jean",
        lastName: "Antunes",
        role: "Marketing (Posicionamento de Marca e Eventos)",
        linkedinUrl: "https://www.linkedin.com/in/jean-antunes-67bb631a1/"
      },
      {
        firstName: "Camila",
        lastName: "Biondo",
        role: "Design de Produtos (Promob e Materiais Técnicos)",
        linkedinUrl: "https://www.linkedin.com/in/camila-biondo-8370a0261/"
      }
    ];
    ...
    for (const lead of leads) {
      ...
      const newLeadPayload = {
        ...
        "Descripcion de la idea": `${lead.role} na Italínea Móveis.`,
    ...
    console.log("🚀 Inyección Batch 3 de Italínea completada exitosamente.");
  } catch (err) {
    console.error("Error procesando leads Batch 3 Italínea:", err);
  }
}
