...
async function run() {
  try {
    ...
    console.log('2. Buscando tokens de API creados...');
    // Endpoint para ver tokens del usuario
    const tokens = await request('GET', '/api/user/tokens/', null, token);
    console.log('Tokens encontrados:', JSON.stringify(tokens, null, 2));
  } catch (error) {
