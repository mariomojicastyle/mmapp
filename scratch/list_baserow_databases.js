...
async function run() {
  try {
    ...
    console.log('2. Obteniendo todas las aplicaciones/bases de datos...');
    const apps = await request('GET', '/api/applications/', null, token);
    console.log('Bases de datos encontradas:', JSON.stringify(apps, null, 2));
  } catch (error) {
