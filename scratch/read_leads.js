...
async function run() {
  try {
    ...
    const response = await request('GET', `/api/database/rows/table/${tableId}/?user_field_names=true`, null, token);
    console.log(JSON.stringify(response.results.slice(-5), null, 2));
  } catch (error) {
