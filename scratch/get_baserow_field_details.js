...
async function run() {
  try {
    ...
    console.log('2. Consultando detalles del campo ' + fieldId + '...');
    const fieldDetails = await request('GET', `/api/database/fields/${fieldId}/`, null, token);
    console.log('Detalles del campo:', JSON.stringify(fieldDetails, null, 2));
  } catch (error) {
