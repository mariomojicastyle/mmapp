...
async function run() {
  try {
    ...
    // Crear Empresa: Mobler Moveis
    console.log("Creando empresa 'Mobler Moveis'...");
    const newCompany1 = {
    ...
    const moblerId = companyRes1.id;
    console.log("Mobler Moveis creada con ID:", moblerId);
    ...
    const leads = [
      {
        ...
        lastName: "Moresca",
        role: "Gerente Geral",
        linkedinUrl: "https://www.linkedin.com/in/cesar-moresca-b9874671/",
        companyName: "Mobler Moveis",
        companyId: moblerId,
        companyDomain: "moblermoveis.com.br",
        companyPhone: "", 
        companyWhatsApp: "",
        country: "Brasil"
      }
