...
def test_int32():
    ...
    for n_cajones in [1, 2, 3]:
        print(f"\n=== PROBANDO CON RH_IN:Cantidada de Cajones = {n_cajones} (System.Int32) ===")
        payload_rc = {
            "algo": b64_algo,
            "pointer": None,
            "values": [
                ...
                {"ParamName": "RH_IN:Cantidada de Cajones", "InnerTree": {"{0}": [{"type": "System.Int32", "data": str(n_cajones)}]}},
                {"ParamName": "RH_IN:Cantidad de Cajones", "InnerTree": {"{0}": [{"type": "System.Int32", "data": str(n_cajones)}]}},
                {"ParamName": "RH_IN:Profundidad cajon", "InnerTree": {"{0}": [{"type": "System.Int32", "data": "351"}]}},
                {"ParamName": "RH_IN:Altura lateral de cajon", "InnerTree": {"{0}": [{"type": "System.Int32", "data": "102"}]}}
            ]
        }
        ...
        print(f"[CANTIDAD CAJONES = {n_cajones}] TOTAL MALLAS DEVUELTAS: {len(real_meshes)} | FRENTES EXTRAÍDOS: {len(frentes)}")
