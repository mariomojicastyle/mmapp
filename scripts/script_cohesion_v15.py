...
# UMBRAL A 0.03 para alcanzar a unir la Cubierta con su MDP. 
UMBRAL_CENTROS = 0.03 
...
def ejecutar_cohesion():
    print("\n--- INICIANDO COHESIÓN ESPACIAL (PASO 2 DEFINITIVO V15) ---")
    ...
    # AGRUPAMIENTO GEOMÉTRICO (V12 MEJORADA PARA RESOLVER LA PARADOJA)
    grupos_fisicos = []
    ...
    while mallas_pendientes:
        ...
        # NORMA: Si la pieza es un Herraje (ej. Caja o Perno), NO participa en la cohesión.
        # Va directamente a la lista final sola. Así jamás se unirá con otra pieza.
        ...
        for otra in mallas_pendientes:
            ...
            # NORMA: Ignoramos los herrajes en la búsqueda.
            ...
            if centro_actual and centro_otra:
                ...
                # UMBRAL_CENTROS = 0.03 asegura que la Cubierta alcance a su MDP
