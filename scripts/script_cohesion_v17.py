...
def determinar_nombre_base(nombres_en_grupo):
    # Prioridad 1: Si hay un herraje en el grupo, el grupo entero toma el nombre del herraje
...
def should_group(actual, otra):
    ...
    # REGLA 1: Por distancia de Centros (Núcleo estable de V12 para unir Capas)
    ...
    # REGLA 2: Por Contención (Atrapa recortes o fragmentos)
    if n1 == n2:
...
def ejecutar_cohesion():
    print("\n--- INICIANDO COHESIÓN ESPACIAL V17 (AVANZADA + HERRAJES) ---")
    ...
    # ---------------------------------------------------------
    # Permite que los herrajes absorban partes de sí mismos ("Bisagra.001") 
    # y mallas huérfanas sin nombre ("Mesh_119") que exportó Grasshopper.
    ...
    for actual in herrajes_iniciales:
        ...
        for otra in mallas_pendientes:
            ...
            # Si la otra malla es una pieza huérfana de tipo "Mesh" o comparte el exacto mismo nombre base
