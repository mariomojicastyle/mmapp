...
def ejecutar_cohesion():
    print("\n--- INICIANDO COHESIÓN ESPACIAL V26 (BÚSQUEDA INTELIGENTE DE PADRES) ---")
    ...
    for h in huerfanos:
        ...
        for g in grupos_finales:
            ...
            # Reducimos el margen a 5mm para que el Paral no crea que contiene al parche accidentalmente
            if bbox_contains(principal, h, margin=0.005):
        ...
        if candidatos:
            # 1. Preferencia absoluta: Mismo nombre base (Tu sugerencia: unirse a su Frente de cajón)
            ...
            if coincidencias_nombre:
                ...
                # 2. Si ninguno tiene su nombre, unirse a la madera que lo contiene más cercana
