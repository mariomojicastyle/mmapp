...
def bake_geometry_nodes_instances(emitter_prefix="Plane", start_frame=None, end_frame=None):
    """
    Bakea las animaciones de todos los Geometry Nodes asociados a objetos que empiecen con 'emitter_prefix'
    DIRECTAMENTE en los objetos reales de la escena, evitando la creación de copias ficticias.
    Elimina los planos emisores al finalizar para dejar la escena limpia con sus animaciones.
    """
    ...
    print(f"\n==================================================")
    print(f"INICIANDO BAKE DIRECTO EN OBJETOS ORIGINALES (V1)")
    ...
    for orig_obj, keyframes in list(bake_data.items()):
        ...
        for frame, matrix in keyframes:
            ...
            # Aplicar la matriz de transformación global directamente (como en la versión que funcionaba)
