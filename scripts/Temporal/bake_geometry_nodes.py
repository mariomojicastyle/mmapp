...
def bake_geometry_nodes_instances(emitter_prefix="Plane", start_frame=None, end_frame=None, export_glb=True, revert_blend=True):
    ...
    print(f"\n==================================================")
    print(f"INICIANDO BAKE DIRECTO Y EXPORTACIÓN GLB CON DRACO (V3)")
    ...
    if export_glb:
        ...
        if not blend_filepath:
            ...
            print(f"\nFase 3: Exportando a archivo GLB con compresión Draco en: {export_path}...")
            try:
                # Exportar escena usando ACTIVE_ACTIONS para fusionar pistas y activando compresión Draco
    ...
    if revert_blend:
        print("\nFase 4: Revirtiendo archivo .blend para restaurar el estado limpio original...")
    ...
    print(f"\n==================================================")
    print(f"BAKE Y EXPORTACIÓN COMPLETADOS EXITOSAMENTE (V3)")
