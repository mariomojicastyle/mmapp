...
* **[2026-07-13] Modo de Arranque Móvil, Fullscreen Directo, Altura del Iframe y Cargador Adaptativo:**
    ...
    - **Integración de Controles (Exit Fullscreen con Botón 'X' Simétrico)**:
      ...
      - Posicionado el botón `.close-fullscreen-btn` en [RealidadAumentada.css](file:///c:/Desarrollo/mmapp/legacy-aplicativo-armado/src/features/AssemblyInstructions/components/NavBarSuperior/RealidadAumentada/RealidadAumentada.css) a `left: 15px; bottom: 200px` en móviles, logrando una simetría geométrica perfecta con el de AR (`right: 15px; bottom: 200px`) en el eje Y.
