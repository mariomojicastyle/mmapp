...
* **[2026-07-23] Visor 3D y Landing Page — Elevación de Botones Inferiores y Viewport Dinámico (100dvh):**
    - **Elevación de la Barra de Controles Inferior**: Modificado el margen inferior de `.contenedor` a `bottom: calc(52px + env(safe-area-inset-bottom))` en [NavBarInferior.css](file:///c:/Desarrollo/mmapp/legacy-aplicativo-armado/src/features/AssemblyInstructions/components/NavBarInferior/NavBarInferior.css) y [calibrador.html](file:///c:/Desarrollo/mmapp/legacy-aplicativo-armado/calibrador.html), garantizando la visibilidad 100% limpia de los botones redondos sin recortes.
    - **Viewport Dinámico**: Reemplazado `vh` por `100dvh` en [LiveDemo.tsx](file:///c:/Desarrollo/mmapp/mario-mojica-homepage/src/components/LiveDemo.tsx) para adaptar la altura de maximizado a las barras del sistema operativo móvil.
