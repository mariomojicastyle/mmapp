...
* **[2026-06-24] AppArmado_v31 — Blindaje Legal Fase 4, Refactorización de Escena R3F y Ofuscación de Nombres**:
    ...
    - **Corrección de ReferenceError**: Se reparó un bug en tiempo de ejecución (`focalDistance_origin is not defined`) en la lógica de configuración focal del visor 3D, mapeando correctamente la referencia al nuevo `defaultFov`.
