...
export default function HowItWorksSteps() {
  ...
  const steps = [
    {
      num: '1',
      title: t('Envíanos tu mueble', 'Send us your furniture details'),
      desc: t(
    ...
    {
      num: '2',
      title: t('Nosotros lo transformamos', 'We transform it'),
      desc: t(
    ...
    {
      num: '3',
      title: t('Imprime tu QR y listo', 'Print your QR & start'),
      desc: t(
  ...
  return (
    <section className="py-24 px-4 bg-surface-light dark:bg-surface-dark border-y border-border-light dark:border-border-dark">
      <div className="container mx-auto">
        ...
        >
          {t('Integra el manual en 3 simples pasos', 'Integrate the manual in 3 simple steps')}
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          {t('Sin complicaciones técnicas. Nosotros nos encargamos de todo.', 'No technical complications. We handle everything.')}
        </motion.p>
