...
export default function MetricsSection() {
  ...
  const bullets = [
    {
      icon: "filter_alt",
      title: t("Embudo de Retención", "Retention Funnel"),
      description: t(
    ...
    {
      icon: "monitoring",
      title: t("Tasa de Finalización", "Completion Rate"),
      description: t(
    ...
    },
    {
      ...
      title: t("Análisis de Sentimiento", "Sentiment Analysis"),
      description: t(
    ...
    {
      icon: "devices",
      title: t("Distribución por Dispositivo", "Device Distribution"),
      description: t(
  ...
  const metrics = [
    ...
    {
      label: t("Abandonos Paso 8", "Step 8 Drop-offs"),
      value: "32",
      color: "text-red-400",
      barColor: "bg-red-400",
      barWidth: "w-2/5",
    ...
    {
      label: t("Sentimiento Positivo", "Positive Sentiment"),
      value: "74%",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
        ...
        >
          <span className="text-primary text-xs uppercase tracking-widest font-bold mb-4 inline-block">
            {t("Diferenciador Clave", "Key Differentiator")}
          </span>
          <h2 className="text-3xl lg:text-4xl font-bold mb-8 text-text-light dark:text-text-dark">
            {t("Toma decisiones basadas en datos reales de tus clientes", "Make decisions based on real data from your customers")}
          </h2>
          ...
          <div className="bg-background-dark rounded-2xl p-8 border border-border-dark shadow-2xl">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-sm text-text-muted-dark">
                {t("Reporte Ejecutivo • Junio 2026", "Executive Report • June 2026")}
              </span>
            </div>
            ...
            <p className="mt-4 text-center text-xs text-text-muted-dark italic">
              {t("Vista previa del reporte PDF automatizado", "Preview of the automated PDF report")}
            </p>
          </div>
        </motion.div>
      </div>
