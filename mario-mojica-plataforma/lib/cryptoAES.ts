...
async function deriveKey(manualId: string): Promise<CryptoKey> {
...
export async function encryptBuffer(arrayBuffer: ArrayBuffer, manualId: string): Promise<ArrayBuffer> {
...
export async function decryptBuffer(arrayBuffer: ArrayBuffer, manualId: string): Promise<ArrayBuffer> {
  const key = await deriveKey(manualId);
