      ...
      <tr>
        <td valign="middle" style="padding-right: 20px; border-right: 2px solid #0088aa;">
          <a href="https://mariomojica.com" target="_blank" style="text-decoration: none;">
            <img src="https://mariomojica.com/Logo_MM_en_v2.png" alt="Mario Mojica" width="115" style="border: 0; display: block; width: 115px; height: auto;" />
          </a>
        </td>
        <td valign="middle" style="padding-left: 20px; text-align: left;">
          ...
          <div style="font-size: 11px; font-weight: 600; color: #0088aa; text-transform: uppercase; margin: 2px 0 8px 0; line-height: 14px; letter-spacing: 0.05em;">
            Founder & CEO | Manufacturing Software Developer
          </div>
          ...
          <div style="margin-top: 10px; font-size: 11px; color: #64748b; line-height: 15px;">
            <div style="font-style: italic; color: #64748b;">Transforming the Furniture Industry</div>
            <div style="font-weight: 600; color: #0088aa; margin-top: 2px;">The future is built starting today</div>
          </div>
        </td>
      </tr>
    </table>
