  ...
  return (
    <div className="flex flex-col gap-6 p-6 h-full">
      ...
      <div className="flex flex-col gap-6 lg:flex-row flex-1">
        {/* TabMenu Area */}
        <div className="flex flex-col gap-1 rounded-2xl bg-surface-container-low p-2 w-full lg:w-72 shrink-0 h-fit shadow-sm border border-outline-variant/10">
        ...
        <div className="flex-1 flex flex-col">
          <div className="rounded-3xl border border-outline-variant/10 bg-surface-container-low p-8 lg:p-12 shadow-sm min-h-[500px] flex-1 flex flex-col items-center justify-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
